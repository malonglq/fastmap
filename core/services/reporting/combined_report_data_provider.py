        ...
        try:
            ...
            combined_data = {
                **traditional_data,
                ...
                'summary': self.get_summary_data(),  # 添加摘要数据
                'report_metadata': {
    ...
    def _prepare_multi_dimensional_analysis_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            formatted_data = {
                ...
                'temperature_span_analysis': multi_result.get('temperature_span_analysis', {}),
            ...
            if self.include_multi_dimensional and self.multi_dimensional_analyzer:
                ...
                if multi_result:
                    ...
                    summary.update({
                        ...
                        'processing_duration': f"{summary_stats.get('processing_duration', 0):.2f}s"
                    })
